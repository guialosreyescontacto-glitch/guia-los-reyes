...
- **Carrusel de destacados en la portada**: arriba de las categorías, un desfile horizontal continuo de tarjetas medianas —badge dorado, foto o logotipo, nombre, categoría y los iconos de contacto— que avanza a velocidad constante, sin frenadas ni saltos. Se dibujan dos tandas idénticas y la cinta recorre el ancho exacto de una, de modo que al reiniciar el ciclo la segunda queda justo donde arrancó la primera. La ventana mide lo mismo que la caja de contenido, así que el carrusel empieza y termina en el mismo margen que el resto de la página, con un desvanecido en los costados que marca ese límite. En cada carga se sortean hasta 10 de los negocios con plan Destacado, así que la rotación es pareja entre todos los clientes del plan y nadie queda siempre fuera.
- **Control manual del carrusel**: en escritorio, dos flechas flotantes sobre los costados avanzan o retroceden un bloque de tarjetas enteras —las que quepan a la vista— y se encienden en el verde de la marca al pasar el cursor. En cualquier pantalla el carrusel también se lleva arrastrando con el ratón o deslizando con el dedo, con un impulso al soltar; en el teléfono las flechas se ocultan para no tapar las tarjetas. El desfile automático se detiene mientras el cursor, el foco o el dedo están encima y lo retoma dos segundos y medio después de soltar, así que nunca pelea con el usuario. Si el sistema pide menos animación no hay desfile: las flechas y el dedo siguen sirviendo, pero sin suavizado.
