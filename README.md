...
- **Banner VIP en la portada**: los negocios con plan Premium rotan en un banner exclusivo, al lado derecho del texto del hero en escritorio y debajo de él en móvil. En escritorio se ven **dos negocios a la vez** y en el teléfono uno, y la página cambia cada 4 segundos: con el doble de tarjetas en pantalla y el cambio más seguido, una cartera de diez clientes Premium da la vuelta completa en veinte segundos. En la vista de dos, la tarjeta acomoda la foto o el logotipo arriba y el texto debajo, con la barra de contacto al pie; en la de una conserva el formato ancho de texto y foto lado a lado. Los puntos de abajo cambian de página a mano, y el último grupo se alinea con el borde derecho en vez de dejar un hueco. No rota sola si el sistema pide menos animación, ni mientras el cursor o el foco están encima.
- **Carrusel de destacados en la portada**: arriba de las categorías, un desfile horizontal continuo de tarjetas —badge dorado, foto o logotipo, nombre, categoría y los iconos de contacto— que avanza a velocidad constante, sin frenadas ni saltos. Las tarjetas miden exactamente lo mismo que las de "Explora por categoría" y siguen sus mismos cortes: 2 por pantalla en el teléfono, 3 desde 560px y 4 desde 900px, así que el carrusel y la cuadrícula de abajo caen en la misma retícula. Empieza y termina en el margen de la página, con un corte limpio contra ese borde. Se dibujan dos tandas idénticas y la cinta recorre el ancho exacto de una, de modo que al reiniciar el ciclo la segunda queda justo donde arrancó la primera. En cada carga se sortean hasta 10 de los negocios con plan Destacado, así que la rotación es pareja entre todos los clientes del plan y nadie queda siempre fuera.
- **Control manual del carrusel**: en escritorio, dos flechas flotantes sobre los costados avanzan **un negocio a la vez** y lo dejan alineado al filo de la tarjeta —antes de moverse redondean al filo más cercano, así ninguna queda cortada a la mitad— y se encienden en el verde de la marca al pasar el cursor. En cualquier pantalla el carrusel también se lleva arrastrando con el ratón o deslizando con el dedo, con un impulso al soltar; en el teléfono las flechas se ocultan para no tapar las tarjetas. El desfile automático se detiene mientras el cursor, el foco o el dedo están encima y lo retoma dos segundos y medio después de soltar, así que nunca pelea con el usuario. Si el sistema pide menos animación no hay desfile: las flechas y el dedo siguen sirviendo, pero sin suavizado.
