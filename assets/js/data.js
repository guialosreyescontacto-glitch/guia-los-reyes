...
/* --- Catálogo ------------------------------------------------------------
   ...
   redes  OPCIONAL. Usuarios (no URLs) de cada red: { facebook, instagram,
          tiktok }. Solo se dibuja el icono de las redes que existan.
   ------------------------------------------------------------------------ */
const CATEGORIAS = [
  {
    id: 'salud',
    ...
    negocios: [
      { nombre: 'Clínica Santa Cecilia', plan: 'destacado', filtro: 'especialistas', rating: 4.8,
        ...
        redes: { facebook: 'demo.clinicasantacecilia', instagram: 'demo.clinicasantacecilia', tiktok: 'demo.clinicasantacecilia' },
      ...
      { nombre: 'Dental Sonrisa Los Reyes', plan: 'destacado', filtro: 'dental', rating: 4.9,
        ...
        redes: { facebook: 'demo.dentalsonrisalosreyes', instagram: 'demo.dentalsonrisalosreyes', tiktok: 'demo.dentalsonrisalosreyes' },
...

  {
    ...
    negocios: [
      { nombre: 'Taller Mecánico El Aguacate', plan: 'destacado', filtro: 'general', rating: 4.9,
        ...
        redes: { facebook: 'demo.tallermecanicoelaguacate', instagram: 'demo.tallermecanicoelaguacate', tiktok: 'demo.tallermecanicoelaguacate' },
      ...
      { nombre: 'Grúas Los Reyes 24/7', plan: 'destacado', filtro: 'grua', rating: 4.7,
        ...
        redes: { facebook: 'demo.gruaslosreyes247', instagram: 'demo.gruaslosreyes247', tiktok: 'demo.gruaslosreyes247' },
...

  {
    ...
    negocios: [
      { nombre: 'Iron Fit Gym', plan: 'destacado', filtro: 'gym', rating: 4.8,
        ...
        redes: { facebook: 'demo.ironfitgym', instagram: 'demo.ironfitgym', tiktok: 'demo.ironfitgym' },
      ...
      { nombre: 'Box Fit Los Reyes', plan: 'destacado', filtro: 'artes', rating: 4.7,
        ...
        redes: { facebook: 'demo.boxfitlosreyes', instagram: 'demo.boxfitlosreyes', tiktok: 'demo.boxfitlosreyes' },
...

  {
    ...
    negocios: [
      { nombre: 'Birriería Doña Chuy', plan: 'destacado', filtro: 'mexicana', rating: 4.9,
        ...
        redes: { facebook: 'demo.birrieriadonachuy', instagram: 'demo.birrieriadonachuy', tiktok: 'demo.birrieriadonachuy' },
      ...
      { nombre: 'Mariscos El Muelle', plan: 'destacado', filtro: 'mariscos', rating: 4.7,
        ...
        redes: { facebook: 'demo.mariscoselmuelle', instagram: 'demo.mariscoselmuelle', tiktok: 'demo.mariscoselmuelle' },
...

  {
    ...
    negocios: [
      { nombre: 'Estética Glamour', plan: 'destacado', filtro: 'estetica', rating: 4.8,
        ...
        redes: { facebook: 'demo.esteticaglamour', instagram: 'demo.esteticaglamour', tiktok: 'demo.esteticaglamour' },
      ...
      { nombre: 'Barbería El Clásico', plan: 'destacado', filtro: 'barberia', rating: 4.9,
        ...
        redes: { facebook: 'demo.barberiaelclasico', instagram: 'demo.barberiaelclasico', tiktok: 'demo.barberiaelclasico' },
...

  {
    ...
    negocios: [
      { nombre: 'Cerrajería Rápida Los Reyes', plan: 'destacado', filtro: 'cerrajeros', rating: 4.9,
        ...
        redes: { facebook: 'demo.cerrajeriarapidalosreyes', instagram: 'demo.cerrajeriarapidalosreyes', tiktok: 'demo.cerrajeriarapidalosreyes' },
      ...
      { nombre: 'Plomería Hermanos Ruiz', plan: 'destacado', filtro: 'fontaneros', rating: 4.7,
        ...
        redes: { facebook: 'demo.plomeriahermanosruiz', instagram: 'demo.plomeriahermanosruiz', tiktok: 'demo.plomeriahermanosruiz' },
...

  {
    ...
    negocios: [
      { nombre: 'Despacho Contable Aguilar', plan: 'destacado', filtro: 'contadores', rating: 4.8,
        ...
        redes: { facebook: 'demo.despachocontableaguilar', instagram: 'demo.despachocontableaguilar', tiktok: 'demo.despachocontableaguilar' },
      ...
      { nombre: 'Bufete Jurídico Los Reyes', plan: 'destacado', filtro: 'abogados', rating: 4.6,
        ...
        redes: { facebook: 'demo.bufetejuridicolosreyes', instagram: 'demo.bufetejuridicolosreyes', tiktok: 'demo.bufetejuridicolosreyes' },
...

  {
    ...
    negocios: [
      { nombre: 'Veterinaria Huellitas', plan: 'destacado', filtro: 'veterinarias', rating: 4.9,
        ...
        redes: { facebook: 'demo.veterinariahuellitas', instagram: 'demo.veterinariahuellitas', tiktok: 'demo.veterinariahuellitas' },
      ...
      { nombre: 'Pet Spa Los Reyes', plan: 'destacado', filtro: 'estetica', rating: 4.8,
        ...
        redes: { facebook: 'demo.petspalosreyes', instagram: 'demo.petspalosreyes', tiktok: 'demo.petspalosreyes' },
...

  {
    ...
    negocios: [
      { nombre: 'Jardín de Eventos Los Sauces', plan: 'destacado', filtro: 'salones', rating: 4.8,
        ...
        redes: { facebook: 'demo.jardindeeventoslossauces', instagram: 'demo.jardindeeventoslossauces', tiktok: 'demo.jardindeeventoslossauces' },
      ...
      { nombre: 'Banquetes Doña Male', plan: 'destacado', filtro: 'banquetes', rating: 4.9,
        ...
        redes: { facebook: 'demo.banquetesdonamale', instagram: 'demo.banquetesdonamale', tiktok: 'demo.banquetesdonamale' },
...

  {
    ...
    negocios: [
      { nombre: 'Instituto de Inglés Bridge', plan: 'destacado', filtro: 'idiomas', rating: 4.8,
        ...
        redes: { facebook: 'demo.institutodeinglesbridge', instagram: 'demo.institutodeinglesbridge', tiktok: 'demo.institutodeinglesbridge' },
      ...
      { nombre: 'Academia de Música Do Re Mi', plan: 'destacado', filtro: 'musica', rating: 4.9,
        ...
        redes: { facebook: 'demo.academiademusicadoremi', instagram: 'demo.academiademusicadoremi', tiktok: 'demo.academiademusicadoremi' },
...

  {
    ...
    negocios: [
      { nombre: 'Inmobiliaria Raíces de Michoacán', plan: 'destacado', filtro: 'agentes', rating: 4.7,
        ...
        redes: { facebook: 'demo.inmobiliariaraicesdemichoacan', instagram: 'demo.inmobiliariaraicesdemichoacan', tiktok: 'demo.inmobiliariaraicesdemichoacan' },
      ...
      { nombre: 'Rentas Los Reyes', plan: 'destacado', filtro: 'renta', rating: 4.6,
        ...
        redes: { facebook: 'demo.rentaslosreyes', instagram: 'demo.rentaslosreyes', tiktok: 'demo.rentaslosreyes' },
...

  {
    ...
    negocios: [
      { nombre: 'Ferretería El Tornillo Feliz', plan: 'destacado', filtro: 'ferreteria', rating: 4.8,
        ...
        redes: { facebook: 'demo.ferreteriaeltornillofeliz', instagram: 'demo.ferreteriaeltornillofeliz', tiktok: 'demo.ferreteriaeltornillofeliz' },
      ...
      { nombre: 'Boutique Aura', plan: 'destacado', filtro: 'ropa', rating: 4.7,
        ...
        redes: { facebook: 'demo.boutiqueaura', instagram: 'demo.boutiqueaura', tiktok: 'demo.boutiqueaura' },
