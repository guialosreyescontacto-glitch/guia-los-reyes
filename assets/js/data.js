...
/* --- Catálogo ------------------------------------------------------------
   ...
   negocio:   { nombre, plan: 'premium'|'destacado'|'completa'|'basico', filtro,
                tags[], desc, zona, horario, tel, correo?,
                redes{}, mapa?, foto? }

   No hay calificación, y es a propósito. Una estrella sólo vale lo que valga
   quien la puso: para que signifique algo hacen falta cuentas, moderación y
   alguien que atienda al negocio que se queja de una reseña injusta. Eso es
   otro producto. Puesta a mano no era una calificación sino una opinión del
   que llenó el catálogo, con el nombre de un negocio real debajo. Lo que sí
   dice algo del negocio —a qué hora abre, dónde está, cómo se le llama— ya
   está en la ficha.
   ...
   plan   manda en el orden y en cuánto se enseña de cada negocio. De arriba
          ...
          primero los que están abiertos a esta hora y entre ellos al azar.
...
const CATEGORIAS = [
  {
    ...
    negocios: [
      ...
      { nombre: 'Dental Sonrisa Los Reyes', plan: 'destacado', filtro: 'dental',
      ...
      { nombre: 'Laboratorio Clínico del Valle', plan: 'completa', filtro: 'lab',
        tags: ['Análisis clínicos', 'Resultados en línea'], zona: 'Col. Ferrocarril',
        horario: 'Lun a Sáb · 7:00 – 14:00', tel: '523541000103',
      ...
      { nombre: 'Consultorio Dr. Ramírez', plan: 'basico', filtro: 'medicos',
        tags: ['Medicina general', 'A domicilio'], zona: 'Barrio de San Sebastián',
        horario: 'Lun a Vie · 10:00 – 19:00', tel: '523541000104',
      ...
      { nombre: 'Óptica Visión Clara', plan: 'completa', filtro: 'optica',
      ...
      { nombre: 'Fisioterapia Movimiento', plan: 'basico', filtro: 'especialistas',
      ...
      { nombre: 'Consultorio Dental Vida', plan: 'basico', filtro: 'dental',
      ...
      { nombre: 'Nutrióloga Ana Cordero', plan: 'basico', filtro: 'especialistas',
...

  {
    ...
    negocios: [
      { nombre: 'Taller Mecánico El Aguacate', plan: 'premium', filtro: 'general',
      ...
      { nombre: 'Grúas Los Reyes 24/7', plan: 'destacado', filtro: 'grua',
        tags: ['Servicio 24h', 'Carretera', 'Arrastre'], zona: 'Cobertura regional',
        horario: 'Disponible 24 horas', tel: '523541000202',
      ...
      { nombre: 'Llantera El Rayo', plan: 'completa', filtro: 'llantas',
        tags: ['Montaje', 'Balanceo', 'Parches'], zona: 'Carretera a Jacona',
        horario: 'Lun a Dom · 8:00 – 21:00', tel: '523541000203',
      ...
      { nombre: 'Servicio Diésel El Trailero', plan: 'basico', filtro: 'general',
        tags: ['Diésel', 'Camiones', 'Maquinaria'], zona: 'Libramiento Sur',
        horario: 'Lun a Sáb · 8:00 – 18:00', tel: '523541000206',
...

  {
    ...
    negocios: [
      { nombre: 'Iron Fit Gym', plan: 'destacado', filtro: 'gym',
        tags: ['Pesas', 'Cardio', 'Rutinas personalizadas'], zona: 'Av. Juárez',
        horario: 'Lun a Sáb · 5:30 – 22:00', tel: '523541000301',
      ...
      { nombre: 'Box Fit Los Reyes', plan: 'destacado', filtro: 'artes',
        tags: ['Boxeo', 'Kickboxing', 'Clase de prueba gratis'], zona: 'Col. Morelos',
        horario: 'Lun a Vie · 6:00 – 21:00', tel: '523541000302',
      ...
      { nombre: 'Funcional Box 360', plan: 'completa', filtro: 'crossfit',
        tags: ['Entrenamiento funcional', 'Retos mensuales'], zona: 'Fracc. Los Laureles',
        horario: 'Lun a Vie · 6:00 – 21:00', tel: '523541000305',
...

  {
    ...
    negocios: [
      { nombre: 'Birriería Doña Chuy', plan: 'premium', filtro: 'mexicana',
        tags: ['Birria de res', 'Desayunos', 'Para llevar'], zona: 'Mercado Municipal',
        horario: 'Mar a Dom · 7:00 – 14:00', tel: '523541000401',
      ...
      { nombre: 'Mariscos El Muelle', plan: 'destacado', filtro: 'mariscos',
        tags: ['Cocteles', 'Pescado zarandeado', 'Servicio a domicilio'], zona: 'Av. Madero',
        horario: 'Mar a Dom · 12:00 – 19:00', tel: '523541000402',
      ...
      { nombre: 'Café de Altura Michoacán', plan: 'basico', filtro: 'cafe',
        tags: ['Café de la región', 'Repostería', 'Wi-Fi'], zona: 'Portal Morelos',
        horario: 'Lun a Sáb · 8:00 – 22:00', tel: '523541000405',
      ...
      { nombre: 'Cenaduría La Esquina', plan: 'completa', filtro: 'mexicana',
        tags: ['Pozole', 'Enchiladas', 'Cenas'], zona: 'Col. Zaragoza',
        horario: 'Jue a Dom · 18:00 – 23:30', tel: '523541000406',
...

  {
    ...
    negocios: [
      { nombre: 'Estética Glamour', plan: 'destacado', filtro: 'estetica',
        tags: ['Corte y color', 'Keratina', 'Peinados de novia'], zona: 'Centro',
        horario: 'Mar a Dom · 10:00 – 20:00', tel: '523541000501',
      ...
      { nombre: 'Barbería El Clásico', plan: 'destacado', filtro: 'barberia',
        tags: ['Corte clásico', 'Afeitado navaja', 'Sin cita'], zona: 'Av. Hidalgo',
        horario: 'Lun a Sáb · 10:00 – 21:00', tel: '523541000502',
      ...
      { nombre: 'Nails Studio Ale', plan: 'basico', filtro: 'unas',
        tags: ['Acrílicas', 'Gelish', 'Diseños'], zona: 'Col. Emiliano Zapata',
        horario: 'Lun a Sáb · 11:00 – 20:00', tel: '523541000503',
...

  {
    ...
    negocios: [
      { nombre: 'Cerrajería Rápida Los Reyes', plan: 'destacado', filtro: 'cerrajeros',
        tags: ['Emergencias 24h', 'Apertura de autos', 'Copias de llaves'], zona: 'Toda la ciudad',
        horario: 'Disponible 24 horas', tel: '523541000601',
      ...
      { nombre: 'Plomería Hermanos Ruiz', plan: 'destacado', filtro: 'fontaneros',
        tags: ['Fugas', 'Destape de drenaje', 'Boiler'], zona: 'Centro y colonias',
        horario: 'Lun a Dom · 7:00 – 21:00', tel: '523541000602',
      ...
      { nombre: 'Electricista Juan Pablo', plan: 'completa', filtro: 'electricistas',
        tags: ['Instalaciones', 'Cortos', 'Presupuesto gratis'], zona: 'Col. Ferrocarril',
        horario: 'Lun a Sáb · 8:00 – 20:00', tel: '523541000603',
      ...
      { nombre: 'Carpintería La Madera Fina', plan: 'basico', filtro: 'carpinteros',
...

  {
    ...
    negocios: [
      ...
      { nombre: 'Bufete Jurídico Los Reyes', plan: 'destacado', filtro: 'abogados',
        tags: ['Familiar', 'Civil', 'Laboral'], zona: 'Av. Madero',
        horario: 'Lun a Vie · 9:00 – 19:00', tel: '523541000702',
      ...
      { nombre: 'Gestoría Vehicular Express', plan: 'completa', filtro: 'notaria',
        tags: ['Placas', 'Refrendo', 'Licencias'], zona: 'Portal Hidalgo',
        horario: 'Lun a Vie · 9:00 – 17:00', tel: '523541000703',
...

  {
    ...
    negocios: [
      { nombre: 'Veterinaria Huellitas', plan: 'destacado', filtro: 'veterinarias',
        tags: ['Consulta', 'Cirugía', 'Vacunas', 'Urgencias'], zona: 'Av. Juárez',
        horario: 'Lun a Sáb · 9:00 – 20:00', tel: '523541000801',
      ...
      { nombre: 'Pet Spa Los Reyes', plan: 'destacado', filtro: 'estetica',
        tags: ['Baño y corte', 'Razas grandes', 'Servicio a domicilio'], zona: 'Col. Vista Hermosa',
        horario: 'Mar a Dom · 10:00 – 19:00', tel: '523541000802',
      ...
      { nombre: 'Agro Veterinaria El Campo', plan: 'basico', filtro: 'alimento',
        tags: ['Alimento a granel', 'Ganado', 'Medicamentos'], zona: 'Carretera a Peribán',
        horario: 'Lun a Sáb · 8:00 – 19:00', tel: '523541000803',
      ...
      { nombre: 'Guardería Canina Patitas', plan: 'completa', filtro: 'guarderia',
        tags: ['Hospedaje', 'Paseos', 'Adiestramiento'], zona: 'Salida a Tocumbo',
        horario: 'Lun a Dom · 7:00 – 20:00', tel: '523541000804',
...

  {
    ...
    negocios: [
      { nombre: 'Jardín de Eventos Los Sauces', plan: 'premium', filtro: 'salones',
        tags: ['Hasta 400 personas', 'Estacionamiento', 'Alberca'], zona: 'Salida a Tingüindín',
        horario: 'Citas: Lun a Sáb · 10:00 – 19:00', tel: '523541000901',
      ...
      { nombre: 'Banquetes Doña Male', plan: 'destacado', filtro: 'banquetes',
        tags: ['Menú a elegir', 'Meseros', 'Degustación'], zona: 'Los Reyes y región',
        horario: 'Lun a Sáb · 9:00 – 19:00', tel: '523541000902',
      ...
      { nombre: 'DJ Sonido Estelar', plan: 'basico', filtro: 'musica',
        tags: ['Audio e iluminación', 'Pantallas', 'Hora loca'], zona: 'Servicio a domicilio',
        horario: 'Reservas todo el día', tel: '523541000903',
      ...
      { nombre: 'Foto y Video Momentos', plan: 'completa', filtro: 'foto',
        tags: ['Bodas', 'XV años', 'Dron'], zona: 'Centro',
        horario: 'Con cita previa', tel: '523541000904',
      ...
      { nombre: 'Renta de Mobiliario El Detalle', plan: 'basico', filtro: 'renta',
        tags: ['Sillas', 'Mesas', 'Carpas', 'Manteles'], zona: 'Col. Ferrocarril',
        horario: 'Lun a Sáb · 9:00 – 19:00', tel: '523541000905',
...

  {
    ...
    negocios: [
      { nombre: 'Instituto de Inglés Bridge', plan: 'destacado', filtro: 'idiomas',
        tags: ['Niños y adultos', 'Certificación', 'Grupos reducidos'], zona: 'Av. Morelos',
        horario: 'Lun a Vie · 15:00 – 21:00', tel: '523541001001',
      ...
      { nombre: 'Academia de Música Do Re Mi', plan: 'destacado', filtro: 'musica',
        tags: ['Guitarra', 'Piano', 'Canto'], zona: 'Centro',
        horario: 'Lun a Sáb · 16:00 – 20:00', tel: '523541001002',
      ...
      { nombre: 'Regularización Escolar Einstein', plan: 'completa', filtro: 'regularizacion',
        tags: ['Primaria', 'Secundaria', 'Matemáticas'], zona: 'Col. Emiliano Zapata',
        horario: 'Lun a Vie · 16:00 – 20:00', tel: '523541001003',
      ...
      { nombre: 'Centro de Cómputo Digital', plan: 'basico', filtro: 'computacion',
        tags: ['Office', 'Diseño', 'Cursos sabatinos'], zona: 'Portal Hidalgo',
        horario: 'Lun a Sáb · 9:00 – 20:00', tel: '523541001004',
      ...
      { nombre: 'Taller de Repostería Dulce Arte', plan: 'completa', filtro: 'oficios',
        tags: ['Pasteles', 'Fondant', 'Cupos limitados'], zona: 'Col. Morelos',
        horario: 'Sáb · 10:00 – 14:00', tel: '523541001005',
...

  {
    ...
    negocios: [
      { nombre: 'Inmobiliaria Raíces de Michoacán', plan: 'premium', filtro: 'agentes',
        tags: ['Compra-venta', 'Crédito Infonavit', 'Avalúos'], zona: 'Av. Madero',
        horario: 'Lun a Sáb · 9:00 – 19:00', tel: '523541001101',
      ...
      { nombre: 'Rentas Los Reyes', plan: 'destacado', filtro: 'renta',
        tags: ['Casas amuebladas', 'Departamentos', 'Corta estancia'], zona: 'Varias colonias',
        horario: 'Lun a Dom · 9:00 – 20:00', tel: '523541001102',
      ...
      { nombre: 'Huertas y Terrenos del Valle', plan: 'basico', filtro: 'terrenos',
        tags: ['Huertas de aguacate', 'Terrenos', 'Riego'], zona: 'Región de Los Reyes',
        horario: 'Lun a Sáb · 8:00 – 18:00', tel: '523541001103',
      ...
      { nombre: 'Locales Centro Comercial Plaza', plan: 'completa', filtro: 'locales',
        tags: ['Locales', 'Bodegas', 'Estacionamiento'], zona: 'Centro',
        horario: 'Lun a Vie · 10:00 – 18:00', tel: '523541001104',
      ...
      { nombre: 'Casa en Venta Fracc. Los Laureles', plan: 'basico', filtro: 'venta',
        tags: ['3 recámaras', '2 baños', 'Cochera'], zona: 'Fracc. Los Laureles',
        horario: 'Visitas con cita', tel: '523541001105',
...

  {
    ...
    negocios: [
      { nombre: 'Ferretería El Tornillo Feliz', plan: 'destacado', filtro: 'ferreteria',
      ...
      { nombre: 'Boutique Aura', plan: 'destacado', filtro: 'ropa',
        tags: ['Ropa de dama', 'Novedades', 'Apartados'], zona: 'Portal Morelos',
        horario: 'Lun a Sáb · 10:00 – 20:00', tel: '523541001202',
      ...
      { nombre: 'Abarrotes La Central', plan: 'completa', filtro: 'abarrotes',
        tags: ['Mayoreo', 'Recargas', 'Reparto'], zona: 'Mercado Municipal',
        horario: 'Lun a Dom · 7:00 – 21:00', tel: '523541001203',
      ...
      { nombre: 'Muebles y Línea Blanca Hogar', plan: 'basico', filtro: 'muebles',
        tags: ['Crédito', 'Sin buró', 'Entrega gratis'], zona: 'Av. Madero',
        horario: 'Lun a Sáb · 9:00 – 20:00', tel: '523541001204',
      ...
      { nombre: 'Papelería El Estudiante', plan: 'completa', filtro: 'papeleria',
      ...
      { nombre: 'Agroinsumos del Aguacate', plan: 'basico', filtro: 'agro',
        tags: ['Fertilizantes', 'Asesoría técnica', 'Mayoreo'], zona: 'Carretera a Peribán',
        horario: 'Lun a Sáb · 8:00 – 19:00', tel: '523541001206',
